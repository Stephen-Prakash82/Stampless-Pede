...
public final class Constants {
  ...
  public static class OperatorConstants {
    ...
    public static final double kScale = 0.5;
    public static final double[] kRadii = { .5, 1, 1.5 }; // as meters
  }
  ...
  public static class VisionConstants {
    ...
    public static final String[] kCameraNames = { "Camera 1"};
    ...
    public static final Transform3d kRobotToCam = new Transform3d(new Translation3d(0, 0.3937, -0.4699),
        new Rotation3d(Units.degreesToRadians(0), 0, Units.degreesToRadians(0)));
    public static final Matrix<N3, N1> kSingleTagStdDevs = VecBuilder.fill(4, 4, 8);
    public static final Matrix<N3, N1> kMultiTagStdDevs = VecBuilder.fill(0.5, 0.5, 1);
    public static final int ktargetTagIDs = 10;
