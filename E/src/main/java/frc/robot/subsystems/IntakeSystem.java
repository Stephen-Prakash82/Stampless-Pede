...
//     private final TalonFX m_IntakeMotor2 = new TalonFX(IntakeConstants.kIntakeMotor2CanID);
...
//         m_IntakeMotor2.getConfigurator().apply(intakeConfig.Slot0);
//         m_DeployMotor.getConfigurator().apply(deployConfig.Slot0);
//         m_IntakeMotor2.setControl(new Follower(m_IntakeMotor1.getDeviceID(), null));
